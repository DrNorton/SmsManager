...
namespace Phone7.Fx
{
    public class PhoneBootstrapper
    {
        ...
        protected SetRootVisual SetMode { get; set; }
        ...
        private void InitializePhoneApplication()
        {
            ...
            if (SetMode == SetRootVisual.OnNavigated)
        ...
        protected virtual void StartRuntime()
        {
            ...
            BeforeInitializePhoneApplication();
        ...
        protected virtual void BeforeInitializePhoneApplication()
        {
